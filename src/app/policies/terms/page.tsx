  ...
  return (
    <Section className="pt-14">
      ...
      <div className="max-w-2xl space-y-6 text-ink-soft leading-relaxed">
        <div>
          <h2 className="font-serif text-xl text-ink">About These Terms</h2>
          <p className="mt-2">
        ...
        <div>
          <h2 className="font-serif text-xl text-ink">Orders & Payment</h2>
          <p className="mt-2">[Pending — depends on checkout model decision, §9.1.]</p>
        </div>
        <div>
          <h2 className="font-serif text-xl text-ink">Product Information</h2>
          <p className="mt-2">
