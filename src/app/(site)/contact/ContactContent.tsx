...
export function ContactContent() {
  ...
  const { contact } = useLiveSiteContent();

  return (
    <>
      <Section className="pt-14 pb-10 bg-cream-deep text-center">
        <SectionHeading align="center" title={contact.heading} description={contact.description} />
      </Section>
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="mt-1 block text-ink underline underline-offset-4 hover:text-navy"
                >
                  {siteConfig.social.shopee.replace(/^https?:\/\//, "")}
                </a>
